            ...
            >
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            <div className="h-10 mb-4 flex items-center justify-center">
                                <img src="/BRI.png" alt="Bank BRI" className="h-full object-contain" />
                            </div>
                            <p className="text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Bank BRI</p>
                            <p className="text-2xl font-mono text-primary tracking-widest mb-1">107501009280538</p>
                            <p className="text-xs text-slate-500 uppercase font-semibold tracking-wider mb-4">a.n EVA ALVINA</p>

                            <button
                                onClick={() => handleCopy('107501009280538', 'BRI')}
                                className="flex items-center gap-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 px-6 py-2 rounded-full text-xs font-bold transition-colors w-full justify-center"
                            >
                                <span className="material-symbols-outlined text-sm">
                                    {copiedBank === 'BRI' ? 'check_circle' : 'content_copy'}
                                </span>
                                {copiedBank === 'BRI' ? 'Berhasil Disalin!' : 'Salin No. Rekening'}
                            </button>
                        </div>
                    </div>
                </div>
